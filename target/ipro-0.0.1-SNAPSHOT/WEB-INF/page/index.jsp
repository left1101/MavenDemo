		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="http://www.baidu.com"><i class="fa fa-home"></i><span
							class="nav-label">主页</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="http://www.baidu.com">主页示例一</a>
							</li>
						</ul></li>


					<li><a href="http://www.baidu.com" class="J_menuItem"><i
							class="fa fa-home"></i><span class="nav-label">主页</span></a></li>

					<li><a href="javascript:;"><i class="fa fa-bar-chart-o"></i><span
							class="nav-label">统计图表</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="http://www.baidu.com">百度ECharts</a></li>
						</ul></li>
					<li><a href="javascript:;"><i class="fa fa-envelope"></i>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="http://www.baidu.com">收件箱</a></li>
						</ul></li>
						...
						<ul class="nav nav-second-level">
							<li><a href="javascript:;">树形视图 <span class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a class="J_menuItem" href="http://www.baidu.com">jsTree</a></li>
									<li><a class="J_menuItem" href="http://www.baidu.com">Bootstrap
											Tree View</a></li>
									<li><a class="J_menuItem" href="http://www.baidu.com">nestable</a></li>
								</ul></li>
						</ul></li>
				</ul>
			</div>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
								...
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										...
										<div class="media-body">
											<small class="pull-right">46小时前</small> <strong>小四</strong> <br>
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="http://www.baidu.com" frameborder="0" data-id="default"
					seamless></iframe>
			</div>
			<div class="footer">
